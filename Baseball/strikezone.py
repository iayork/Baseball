...
def get_50pct_zone(year=2015):
    ...
    k_zoneL_2009 = [(-1.0, 1.75), (-1.125, 1.875), (-1.25, 2.0), (-1.25, 2.125), (-1.25, 2.25), 
                    (-1.25, 2.375), (-1.25, 2.5), (-1.25, 2.625), (-1.25, 2.75), (-1.125, 2.875), 
                    (-1.125, 3.0), (-1.0, 3.125), (-0.875, 3.25), (-0.25,3.4), (0.5, 3.25), 
                    (0.625, 3.125), (0.75, 3.0),(0.85, 2.625), (0.625, 2.0), (0.375, 1.75), 
                    (-1.0, 1.75)]
